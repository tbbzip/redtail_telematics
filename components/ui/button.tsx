...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "border-rb-red bg-rb-red text-white shadow-sm hover:border-[#a81218] hover:bg-[#a81218]",
        outline:
          "border-border bg-background text-foreground hover:border-rb-red/45 hover:bg-rb-peach/45 hover:text-rb-red aria-expanded:border-rb-red/45 aria-expanded:bg-rb-peach/45 aria-expanded:text-rb-red dark:bg-transparent dark:hover:bg-input/30",
        secondary:
