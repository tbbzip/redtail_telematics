...
export const metadata: Metadata = {
	title: "Cookie Policy | Redtail",
	description: "Cookie policy information for Redtail Telematics.",
};
		...
		<main className="bg-white pt-28 pb-20">
			<section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
				...
				<p className="mt-5 text-base leading-7 text-rb-black/68">
					This page is reserved for Redtail Telematics cookie policy content.
